...
// function Button<T extends string | number>(props: {
//   type: T;
//   size: string;
//   variant: string;
...
//     <button type={props.type} className={`btn-${variant} btn-${size}`}>
//       {props.children}
//     </button>
...
/* function insertAtBeginning(array: any[], element: any): any[] {
  return [element, ...array];
}

const demoArray1 = [1, 2, 3, 4];

const updatedArray1 = insertAtBeginning(demoArray1, 5);

// Will not give an error on compiletime since TS does not what type is inferred here, and that the first element is a number
...
/*  typescript generic insertAtBeggining function
 */

function insertAtBeggining<T>(array: T[], element: T): T[] {
  return [element, ...array];
}

const demoArray2 = [1, 2, 3, 4];

const updatedArray2 = insertAtBeggining(demoArray2, 5);

// Will now give an error on compiletime since TS knows what type is inferred here, and that the first element is a number
