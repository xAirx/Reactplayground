...
/* implementing < ChildComponent />: In the ChildComponent. { props.children }
will render any data that has been passed down from the parent,
allowing the ParentComponent to customize the contents of the ChildComponent.
 */
